...
public class RibbonMain {
	public static void main( String[] args ) throws Exception {  
        ConfigurationManager.loadPropertiesFromResources("com/ray/ribbon/sample-client.properties");  
        System.out.println(
        	"### " + 
        ...
        for(int i = 0; i < 4; i ++) {
            ...
            System.out.println(
            	"Status for URI:" + 
            	response.getRequestedURI() + " is :" + response.getStatus());  
        }  
